...
namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public class GWebsiteAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var testModels = gwebsite.CreateChildPermission(GWebsitePermissions.Pages_Administration_TestModel, L("TestModel"));
            testModels.CreateChildPermission(GWebsitePermissions.Pages_Administration_TestModel_Create, L("CreatingNewTestModel"));
            testModels.CreateChildPermission(GWebsitePermissions.Pages_Administration_TestModel_Edit, L("EditingTestModel"));
