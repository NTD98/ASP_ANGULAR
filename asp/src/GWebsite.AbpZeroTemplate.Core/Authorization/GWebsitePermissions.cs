namespace GWebsite.AbpZeroTemplate.Core.Authorization
{
    ...
    public static class GWebsitePermissions
    {
        ...
        public const string Pages_Administration_TestModel = "Pages.Administration.TestModel";
        public const string Pages_Administration_TestModel_Create = "Pages.Administration.TestModel.Create";
        public const string Pages_Administration_TestModel_Edit = "Pages.Administration.TestModel.Edit";
