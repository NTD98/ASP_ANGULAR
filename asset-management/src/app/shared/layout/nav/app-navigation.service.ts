    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [
                ...
                new AppMenuItem('Quản lý tài sản', 'Pages.Administration.Asset', 'flaticon-open-box', '/app/gwebsite/asset'),
                new AppMenuItem('Quản lý khấu hao', 'Pages.Administration.Depreciation', 'flaticon-diagram', '/app/gwebsite/depreciation')
            ]),
